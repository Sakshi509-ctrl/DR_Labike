...
const MedicalBlogs = () => {
    ...
    const blogTitle = localStorage.getItem('blogTitle') || 'Checkup in Delhi/Gurgaon';
    const blogChangeTitle = localStorage.getItem('blogChangeTitle') || 'Checkup Cost';
    const blogContent = localStorage.getItem('blogContent') || 'Health check-up packages are screenings to assess overall health and detect early signs of disease. Evaluate your health with the best health check-up packages and prevent illnesses.';
    const blogImage = localStorage.getItem('blogImage') || '/assets/freelogo.jpg';
            ...
            <div className="flex">
                ...
                <div className="flex-1 ml-24 mt-8">
                 <div className="bg-white shadow-lg w-[700px] overflow-hidden mb-6">
                   <img src={blogImage} alt="Medical Blogs" className="w-[800px] h-[400px] object-cover"/>
                 </div>
